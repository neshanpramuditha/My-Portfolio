...
const HeroSection = () => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex gap-4 justify-center lg:justify-start">
            {[
              ...
              { icon: Mail, href: "mailto:neshan.pramu@gmail.com", label: "Email" },
      ...
      {/* Scroll indicator */}
      <motion.div
        className="absolute bottom-2 md:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 2 }}
      >
